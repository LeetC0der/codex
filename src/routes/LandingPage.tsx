...
const modules = ['Dashboard', 'Pipeline', 'Connections', 'Settings', 'Secure Logout'];
      ...
      <Grid gutter="xl" align="center">
        <Grid.Col span={{ base: 12, md: 7 }}>
          <Stack gap="md">
            ...
            <Title order={1}>Operate your team from one clean, scalable workspace</Title>
            <Text c="dimmed">
              This home page ships with standard app modules, protected routes, and a modern layout
              pattern that scales for SaaS operations.
            </Text>
