...
export function ConnectionsPage() {
  ...
  const [pendingRemove, setPendingRemove] = useState<DbConnection | null>(null);
  ...
  const openRemoveDialog = (connection: DbConnection) => {
            ...
            <Group justify="end" mt="md">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  dispatch(removeConnection({ id: pendingRemove.id }));
                  setRemoveOpen(false);
